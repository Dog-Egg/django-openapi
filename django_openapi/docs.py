...
def swagger_ui(*openapi: OpenAPI, load_local_static=False):
    ...
    def view(request):
        return render(request, 'swagger-ui.html', context=dict(urls=urls, load_local_static=load_local_static))
